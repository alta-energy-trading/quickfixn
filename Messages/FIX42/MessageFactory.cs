        ...
        public class MessageFactory : IMessageFactory
        {
            ...
            public QuickFix.Message Create(string beginString, string msgType)
            {
                switch (msgType)
                {
                    ...
                    case QuickFix.FIX42.IOI.MsgType: return new QuickFix.FIX42.IOI();
                    ...
                    case QuickFix.FIX42.XML_Non_FIX.MsgType: return new QuickFix.FIX42.XML_Non_FIX();
                    ...
                    case QuickFix.FIX42.AllocationInstructionAck.MsgType: return new QuickFix.FIX42.AllocationInstructionAck();
            ...
            {
                if (QuickFix.FIX42.IOI.MsgType.Equals(msgType))
                {
                    switch (correspondingFieldID)
                    {
                        case QuickFix.Fields.Tags.NoIOIQualifiers: return new QuickFix.FIX42.IOI.NoIOIQualifiersGroup();
                        case QuickFix.Fields.Tags.NoRoutingIDs: return new QuickFix.FIX42.IOI.NoRoutingIDsGroup();
                    }
                }
